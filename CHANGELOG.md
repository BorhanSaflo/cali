...
- Update status bar to display keybinds based on panel focus
...
- Improve panel focus toggle functionality to support direction

- Enhance error handling and messaging

- Implement input and output panel scrolling functionality


### Chore

- Release cali version 0.8.0
